...
var topBarLeft = document.getElementById("topBarLeft"), topBarRight = document.getElementById("topBarRight"), total = document.getElementById("total");

var welcome = document.getElementById("welcome");
var message = document.getElementById("message");
var results = document.getElementById("results");

var startButton = document.getElementById("startButton"), quizContainer = document.getElementById("quizContainer"), quizNotify  = document.getElementById("quizNotify"), quizLength = 0, choices = [] ,
    index = 0, formContainer = document.getElementById("formContainer"), form = document.form1, warning = document.getElementById("warning");

var allQuestions =  [
	{
    "question":"Who is Prime Minister of the India?",
    "choices":["Mr. Narendra Modi","Mr. Rahul Gandhi","None of them"],
    "correctAnswer":0
  },
  {
    "question":"Who won the ipl trophy 2018?",
    "choices":["KKR","MI","DC","CSK"],
    "correctAnswer":3
  },
  {
    "question":"Which film wongthe OSCAR for best film in 2020?",
    "choices":["Toy Story 4","Parasite","Once Upon A Time in Hollywood","Joker"],
    "correctAnswer":1
  },
  {
    "question":"when is world environment day celebrated",
    "choices":["June 4th","July 5th","June 5th","July 4th"],
    "correctAnswer":2
  }
  ];
...
var quizButtons = document.getElementById("quizButtons"), prevButton = document.getElementById("prevButton"), next = document.getElementById("next"),
    nextButton = document.getElementById("nextButton"), scoreButton = document.getElementById("scoreButton");

var scoreDisplay = document.getElementById("scoreDisplay"), myScores = document.getElementById("myScores");
...
message.innerHTML = "Welcome to this quiz! <br><br>Would you like to start?";
